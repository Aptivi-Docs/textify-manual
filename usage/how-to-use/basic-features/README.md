...
{% content-ref url="character-manipulation.md" %}
[character-manipulation.md](character-manipulation.md)
{% endcontent-ref %}

{% content-ref url="string-syntax-attribute.md" %}
[string-syntax-attribute.md](string-syntax-attribute.md)
{% endcontent-ref %}
