...
Textify also provides extra features in order to make various operations, such as Unicode analysis, semantic versioning, and word management, easier than before.

Some of these features are located in the main `Textify` library, and some others are located in the `Textify.Data` library.
...
{% content-ref url="unicode-tools.md" %}
[unicode-tools.md](unicode-tools.md)
{% endcontent-ref %}
