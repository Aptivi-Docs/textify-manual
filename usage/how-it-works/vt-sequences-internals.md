...
Textify contains several techniques on how to work with the VT sequences contained in the text.
...
{% hint style="info" %}
This workaround was not necessary as of the modern .NET implementation, but the workaround is still in place, because Textify targets .NET Standard, which means that it can be used for .NET Fraemwork console projects, and, thus, Mono on Linux.
{% endhint %}
